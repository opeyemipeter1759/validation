...
function inputValidation(input, inputRe, errorMessage1, errorMessage2, event) {
    ...
    if (input.value === "") {
        document.querySelector(".error").innerHTML = document.querySelector(".error").innerHTML + "<br>" + errorMessage1;
        event.preventDefault();
    } else if (!input.value.match(inputRe)) {
        document.querySelector(".error").innerHTML = document.querySelector(".error").innerHTML + "<br>" + errorMessage2;
        event.preventDefault();
        return false;
    } else {
